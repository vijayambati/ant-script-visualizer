...
public class Property
{
    ...
    private void parseEnvironmentForProperties(Element               child,
                                               Map<String, Property> properties)
    {
    ...
    private void parseFileForProperties(Element               child,
                                        Map<String, Property> properties,
                                        Antfile               antfile)
    {
        ...
        if (fileAttribute != null) {
            ...
            } catch (FileNotFoundException e) { // logger.error("Error finding file ", e);
                                                // capture the event
            } catch (IOException e) {
    ...
    private int processLine(int                   lineNumber,
                            String                fileName,
                            String                line,
                            Map<String, Property> properties,
                            List<Property>        unresolvedProperties)
    {
        ...
        if ((line.trim().length() > 0) && !line.startsWith("#") && !line.startsWith("--")) {
            ...
            String keyValue = (strings.length > 1)
                ? strings[1]
    ...
    private void parseNameForProperty(Element               child,
                                      Map<String, Property> properties)
    {
    ...
    /**  */
    private void parseUrlForProperties(Element               element,
                                       Map<String, Property> properties) { }
