...
public class OutputHandler
{
    ...
    public OutputHandler(AntParserUi   ui,
                         List<Antfile> antfiles,
                         AntFileParser antFileParser)
    {
        this.ui       = ui;
    ...
    private String getOutputFileName(File   dotFile,
     ...
     *
     * <p>For instance, if you have an imported buildfile, any calls to a target in that buildfile won't get resolved immediately. So, you need to
     * know which targets are fully resolved. After you've done that, any unresolved dependencies are probably lurking in other buildfiles - but it's
     * a simple matter to get those and set the proper buildfile in the depencency.</p>
     */
    ...
    private void writeDotDependencies(Map<Node, List<Node>> dependencies,
                ...
                if (theNode.shouldPrint(ui.shouldShowTaskdefs(), ui.shouldShowMacrodefs(), ui.shouldShowAntcalls(), ui.shouldShowAntcalls(),
                    ...
                    for (Node dependantNode : dependentNodes) {
                        ...
                        if (dependantNode.getName() != null) {
                            ...
                            if (dependantNode.shouldPrint(ui.shouldShowTaskdefs(), ui.shouldShowMacrodefs(), ui.shouldShowAntcalls(),
                                                              ui.shouldShowAntcalls(), ui.shouldShowTargets())) {
    ...
    /**  */
    private void writeOutputForNode(Node             node,
                                    DataOutputStream out) throws IOException
    {
