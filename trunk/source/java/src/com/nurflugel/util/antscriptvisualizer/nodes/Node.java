...
public abstract class Node
{
    ...
    public boolean equals(Object o)
    {
        ...
        if ((buildFile != null)
                ? (!buildFile.getBuildFile().getAbsolutePath().equals(node.buildFile.getBuildFile().getAbsolutePath()))
                : (node.buildFile != null)) { return false; }
    ...
    public int hashCode()
    {
        int result = ((name != null)
                ? name.hashCode()
                : 0);
        result = (29 * result) + ((buildFile.getBuildFile().getAbsolutePath() != null)
                ? buildFile.getBuildFile().getAbsolutePath().hashCode()
                : 0);
    ...
    public Antfile getBuildFile() { return buildFile; }
    public String getColor() { return color; }

    /** Get any extra formatting information needed for the DOT output. */
    public String getDependencyExtraInfo() { return ""; }
    ...
    public boolean isMacrodef() { return false; }
    ...
    public void writeOutput(DataOutputStream out,
                            AntParserUi      ui) throws IOException
    {

        if (name != null) {
            String niceName = getNiceName();

            if (shouldPrint(ui.shouldShowTaskdefs(), ui.shouldShowMacrodefs(), ui.shouldShowAntcalls(), ui.shouldShowAntcalls(),
    ...
    public boolean shouldPrint(boolean includeTaskdefs,
                               boolean includeMacrodefs,
                               boolean includeAnts,
                               boolean includeAntCalls,
